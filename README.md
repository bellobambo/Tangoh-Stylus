...
bambo@BBambo:~/Tangoh$ cargo stylus export-abi
/**
 * This file was automatically generated by Stylus and represents a Rust program.
 * For more information, please see [The Stylus SDK](https://github.com/OffchainLabs/stylus-sdk-rs).
 */
...
interface ICollegeFundraiser  {
    function init(address escrow) external;

    function registerUser(bytes32 name, uint8 role) external;

    function createTicket(bytes32 title, bytes32 description) external returns (uint256);

    function vote(uint256 ticket_id, bool upvote) external;

    function approveTicket(uint256 ticket_id, uint256 target_amount, uint256 start_time, uint256 end_time) external;

    function closeFundraising(uint256 ticket_id) external;

    function withdrawFunds(uint256 ticket_id, address recipient) external;
    ...
    function getEscrowAccount() external view returns (address);
